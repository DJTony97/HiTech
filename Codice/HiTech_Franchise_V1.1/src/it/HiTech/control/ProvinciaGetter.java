 ...
 */
@WebServlet(name="Provincia",urlPatterns="/ProvinciaGetter")
public class ProvinciaGetter extends HttpServlet {
	private static final long serialVersionUID = 1L;
   
    public ProvinciaGetter() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String reg= request.getParameter("regione");
				...
				risultato=model.doRetrieveProvince(reg);
